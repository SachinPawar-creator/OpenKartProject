...
public class ExtentReportListener extends com.qa.openkart.base.BasePage implements ITestListener
{
 ...
 public synchronized void onTestStart(final ITestResult result) {
     ...
     final String qualifiedName = result.getMethod().getMethodName();
